...
declare namespace Deno {
  namespace core {
    const ops: {
      ...
      op_set_method_option: (handlerType: 'http', handlerName: string, method: string) => void;
      op_set_path_option: (handlerType: 'http', handlerName: string, path: string) => void;
      ...
      // kv
      op_application_keys: (storeName: string, type: string) => Promise<string[]>;
      op_get_application_bytes: (storeName: string, key: string) => Promise<Uint8Array | undefined>;
      op_set_application_bytes: (
        storeName: string,
        key: string,
        value: Uint8Array
      ) => Promise<void>;
      op_get_application_key: (storeName: string, key: string) => Promise<number | undefined>;
      op_set_application_key: (storeName: string, key: string, keyId: number) => Promise<void>;
      op_get_application_string: (storeName: string, key: string) => Promise<string | undefined>;
      op_set_application_string: (storeName: string, key: string, value: string) => Promise<void>;
      op_nft_keys: (
        storeName: string,
      ...
      op_migrate_application_sql: (storeName: string, query: string) => Promise<void>;
      op_migrate_nft_sql: (storeName: string, query: string) => Promise<void>;
      op_migrate_personal_sql: (storeName: string, query: string) => Promise<void>;
    };
  }
}

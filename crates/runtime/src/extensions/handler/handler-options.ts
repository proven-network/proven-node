...
type Output = boolean | number | null | string | Uint8Array | Output[] | { [key: string]: Output };

const { op_add_allowed_origin, op_set_path_option, op_set_timeout_option, op_set_method_option } =
...
export function runWithOptions(
  ...
  if (typeof moduleSpecifier !== 'string' || typeof handlerName !== 'string') {
    throw new Error('runWithOptions must be used in conjunction with the export keyword');
  }
...
export function runOnHttp<P extends string>(
  ...
  if (typeof moduleSpecifier !== 'string' || typeof handlerName !== 'string') {
    throw new Error('runOnHttp must be used in conjunction with the export keyword');
  }
...
export function runOnRadixEvent(
  ...
  if (typeof moduleSpecifier !== 'string' || typeof handlerName !== 'string') {
    throw new Error('runOnRadixEvent must be used in conjunction with the export keyword');
  }

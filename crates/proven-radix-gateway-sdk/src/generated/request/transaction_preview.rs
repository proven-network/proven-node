...
impl TransactionPreviewRequired<'_> {}
impl FluentRequest<'_, TransactionPreviewRequest> {
    ///Set the value of the blobs_hex field.
    pub fn blobs_hex(mut self, blobs_hex: impl IntoIterator<Item = impl AsRef<str>>) -> Self {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, TransactionPreviewRequest> {
    ...
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            ...
            r = r.json(json!({ "end_epoch_exclusive" : self.params.end_epoch_exclusive }));

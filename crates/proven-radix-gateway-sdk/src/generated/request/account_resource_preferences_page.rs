...
pub struct AccountResourcePreferencesPageRequest {
    pub account_address: String,
    pub at_ledger_state: Option<LedgerStateSelector>,
    pub cursor: Option<String>,
    pub limit_per_page: Option<i64>,
}
impl AccountResourcePreferencesPageRequest {}
impl FluentRequest<'_, AccountResourcePreferencesPageRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, AccountResourcePreferencesPageRequest> {
    ...
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/account/page/resource-preferences";

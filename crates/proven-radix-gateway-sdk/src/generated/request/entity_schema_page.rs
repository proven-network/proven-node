...
use serde_json::json;
/**You should use this struct via [`LowLevelClient::entity_schema_page`].

On request success, this will return a [`StateEntitySchemaPageResponse`].*/
#[derive(Debug, Serialize, Deserialize)]
pub struct EntitySchemaPageRequest {
    pub address: String,
    pub at_ledger_state: Option<LedgerStateSelector>,
    pub cursor: Option<String>,
    pub limit_per_page: Option<i64>,
}
impl EntitySchemaPageRequest {}
impl FluentRequest<'_, EntitySchemaPageRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, EntitySchemaPageRequest> {
    type Output = crate::Result<StateEntitySchemaPageResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/entity/page/schemas";

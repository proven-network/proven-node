...
use serde_json::json;
/**You should use this struct via [`LowLevelClient::non_fungible_ids`].

On request success, this will return a [`StateNonFungibleIdsResponse`].*/
...
impl NonFungibleIdsRequest {}
impl FluentRequest<'_, NonFungibleIdsRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, NonFungibleIdsRequest> {
    type Output = crate::Result<StateNonFungibleIdsResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/non-fungible/ids";

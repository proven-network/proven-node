...
use serde_json::json;
/**You should use this struct via [`LowLevelClient::entity_metadata_page`].

On request success, this will return a [`StateEntityMetadataPageResponse`].*/
#[derive(Debug, Serialize, Deserialize)]
pub struct EntityMetadataPageRequest {
    pub address: String,
    pub at_ledger_state: Option<LedgerStateSelector>,
    pub cursor: Option<String>,
    pub limit_per_page: Option<i64>,
}
impl EntityMetadataPageRequest {}
impl FluentRequest<'_, EntityMetadataPageRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, EntityMetadataPageRequest> {
    type Output = crate::Result<StateEntityMetadataPageResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/entity/page/metadata";

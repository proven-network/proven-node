...
use serde_json::json;
/**You should use this struct via [`LowLevelClient::entity_fungibles_page`].

On request success, this will return a [`StateEntityFungiblesPageResponse`].*/
#[derive(Debug, Serialize, Deserialize)]
pub struct EntityFungiblesPageRequest {
    pub address: String,
    ...
    pub opt_ins: StateEntityFungiblesPageRequestOptIns,
}
impl EntityFungiblesPageRequest {}
impl FluentRequest<'_, EntityFungiblesPageRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, EntityFungiblesPageRequest> {
    type Output = crate::Result<StateEntityFungiblesPageResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/entity/page/fungibles/";

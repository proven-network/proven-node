...
use serde_json::json;
/**You should use this struct via [`LowLevelClient::package_blueprint_page`].

On request success, this will return a [`StatePackageBlueprintPageResponse`].*/
#[derive(Debug, Serialize, Deserialize)]
pub struct PackageBlueprintPageRequest {
    pub at_ledger_state: Option<LedgerStateSelector>,
    pub cursor: Option<String>,
    pub limit_per_page: Option<i64>,
    pub package_address: String,
}
impl PackageBlueprintPageRequest {}
impl FluentRequest<'_, PackageBlueprintPageRequest> {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, PackageBlueprintPageRequest> {
    type Output = crate::Result<StatePackageBlueprintPageResponse>;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/state/package/page/blueprints";

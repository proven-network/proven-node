...
use crate::core::group::migration::{MessageSourceType, StreamMessage};
        ...
        while self.current_seq <= self.end_seq {
            ...
            match self
                ...
                Some(log_entry) => {
                    ...
                    // Note: LocalStreamMetadata doesn't have headers, compression, or source fields
                    // so we use defaults for migration
                    let message = StreamMessage {
                        sequence: log_entry.index,
                        timestamp: log_entry.timestamp,
                        data: log_entry.data,
                        headers: std::collections::HashMap::new(),
                        source: MessageSourceType::Consensus,
                    };

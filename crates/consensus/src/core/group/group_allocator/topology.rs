...
impl TopologyAnalyzer {
        ...
        G: Governance,
    {
        ...
        let az_balance_score = TopologyManager::<G>::calculate_az_balance_score(&az_distribution);
        ...
        G: Governance,
    {
        ...
        let az_diversity_score =
            TopologyManager::<G>::calculate_az_diversity_score(&az_distribution, size);
        ...
        G: Governance,
    {
        ...
        *new_az_distribution
        ...
        let new_az_diversity =
            TopologyManager::<G>::calculate_az_diversity_score(&new_az_distribution, new_size);
...
mod tests {
    ...
    fn test_az_balance_score() {
        ...
        let score =
            TopologyManager::<proven_governance_mock::MockGovernance>::calculate_az_balance_score(
                &distribution,
            );
    ...
    fn test_az_diversity_score() {
        ...
        let score =
            TopologyManager::<proven_governance_mock::MockGovernance>::calculate_az_diversity_score(
                &distribution,
                5,
            );
        assert_eq!(score, 0.0);

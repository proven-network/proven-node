...
pub async fn execute(bootstrap: &mut Bootstrap) -> Result<()> {
        ...
        .contains(&NodeSpecialization::EthereumMainnet)
    {
        ...
        let mainnet_reth_node = RethNode::new(RethNodeOptions {
            discovery_port: bootstrap.args.ethereum_mainnet_execution_discovery_port,
            http_port: bootstrap.args.ethereum_mainnet_execution_http_port,
            metrics_port: bootstrap.args.ethereum_mainnet_execution_metrics_port,
            network: RethNetwork::Mainnet,
            rpc_port: bootstrap.args.ethereum_mainnet_execution_rpc_port,
            store_dir: bootstrap.args.ethereum_mainnet_execution_store_dir.clone(),
        });
        ...
        let mainnet_lighthouse_node = LighthouseNode::new(LighthouseNodeOptions {
            ...
            http_port: bootstrap.args.ethereum_mainnet_consensus_http_port,
            metrics_port: bootstrap.args.ethereum_mainnet_consensus_metrics_port,
            network: LighthouseNetwork::Mainnet,
            p2p_port: bootstrap.args.ethereum_mainnet_consensus_p2p_port,
            store_dir: bootstrap.args.ethereum_mainnet_consensus_store_dir.clone(),
        });

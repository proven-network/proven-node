...
pub async fn execute(bootstrap: &mut Bootstrap) -> Result<()> {
        ...
        .contains(&NodeSpecialization::EthereumHolesky)
    {
        ...
        let holesky_reth_node = RethNode::new(RethNodeOptions {
            discovery_port: bootstrap.args.ethereum_holesky_execution_discovery_port,
            http_port: bootstrap.args.ethereum_holesky_execution_http_port,
            metrics_port: bootstrap.args.ethereum_holesky_execution_metrics_port,
            network: RethNetwork::Holesky,
            rpc_port: bootstrap.args.ethereum_holesky_execution_rpc_port,
            store_dir: bootstrap.args.ethereum_holesky_execution_store_dir.clone(),
        });
        ...
        let holesky_lighthouse_node = LighthouseNode::new(LighthouseNodeOptions {
            ...
            http_port: bootstrap.args.ethereum_holesky_consensus_http_port,
            metrics_port: bootstrap.args.ethereum_holesky_consensus_metrics_port,
            network: LighthouseNetwork::Holesky,
            p2p_port: bootstrap.args.ethereum_holesky_consensus_p2p_port,
            store_dir: bootstrap.args.ethereum_holesky_consensus_store_dir.clone(),
        });

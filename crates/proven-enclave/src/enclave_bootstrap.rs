...
impl EnclaveBootstrap {
    ...
    pub async fn start(&self, args: InitializeRequest) -> Result<Arc<Mutex<Enclave>>> {
        ...
        let radix_node_external_fs = ExternalFs::new(
            ...
            "fs-0cd8bbe89dbd432e8.fsx.us-east-2.amazonaws.com:/fsx/babylon/".to_string(),
        ...
        let postgres_external_fs = ExternalFs::new(
            "your-password".to_string(),
            "fs-0cd8bbe89dbd432e8.fsx.us-east-2.amazonaws.com:/fsx/postgres/".to_string(),
        ...
        let nats_external_fs = ExternalFs::new(
            "your-password".to_string(),
            "fs-0cd8bbe89dbd432e8.fsx.us-east-2.amazonaws.com:/fsx/nats/".to_string(),

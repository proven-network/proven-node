...
#[op2(async)]
#[buffer]
pub async fn op_get_application_bytes<AS: Store>(
    ...
    let result = match application_store.get(key).await {
...
#[op2(async)]
pub async fn op_set_application_bytes<AS: Store>(
    state: Rc<RefCell<OpState>>,
    #[string] key: String,
    ...
    let result = application_store.put(key, value).await.is_ok();
...
#[op2(async)]
#[string]
pub async fn op_get_application_string<AS: Store>(
    state: Rc<RefCell<OpState>>,
    #[string] key: String,
) -> Option<String> {
    let application_store = {
...
#[op2(async)]
pub async fn op_set_application_string<AS: Store>(
    state: Rc<RefCell<OpState>>,
    #[string] key: String,
    #[string] value: String,
) -> bool {
...
fn get_ops<AS: Store>() -> Vec<OpDecl> {

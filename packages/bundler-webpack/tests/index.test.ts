...
import { ProvenWebpackPlugin } from '../src/index';
import { BundleManifestGenerator } from '../../bundler-shared/src/index';
import type { Compiler, Compilation } from 'webpack';
import type { ProvenWebpackPluginOptions } from '../src/types';

jest.mock('../../bundler-shared/src/index', () => ({
...
describe('ProvenWebpackPlugin', () => {
  let plugin: ProvenWebpackPlugin;
  let mockCompiler: jest.Mocked<Compiler>;
  let mockCompilation: jest.Mocked<Compilation>;
  ...
  describe('constructor', () => {
    ...
    it('should create plugin with custom options', () => {
      const options: ProvenWebpackPluginOptions = {

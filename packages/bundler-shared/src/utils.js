...
exports.pathToModuleSpecifier = pathToModuleSpecifier;
exports.debounce = debounce;
exports.createHandlerId = createHandlerId;
 ...
 */
function pathToModuleSpecifier(filePath, projectRoot) {
 ...
 */
function createHandlerId(file, handlerName) {

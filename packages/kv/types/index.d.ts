...
export type NftScopedBytesStore = {
    get(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string): Promise<Uint8Array | undefined>;
    keys(nftResourceAddress: string, nftId: string | number | Uint8Array): Promise<string[]>;
    set(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string, value: Uint8Array): Promise<void>;
};
export type NftScopedKeyStore = {
    get(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string): Promise<PrivateKey | undefined>;
    keys(nftResourceAddress: string, nftId: string | number | Uint8Array): Promise<string[]>;
    set(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string, value: PrivateKey): Promise<void>;
};
export type NftScopedStringStore = {
    get(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string): Promise<string | undefined>;
    keys(nftResourceAddress: string, nftId: string | number | Uint8Array): Promise<string[]>;
    set(nftResourceAddress: string, nftId: string | number | Uint8Array, key: string, value: string): Promise<void>;
};
